...
public class CassandraDACImpl extends CassandraOperationImpl {
  ...
  public Response updateMapRecord(
    ...
    try {
      ...
      logInfo(
          requestContext, formatLogMessage("Successfully {} map column - keyspace: {}, table: {}, column: {}, key: {}",
  ...
  public Response updateSetRecord(
    ...
    try {
      ...
      logInfo(
          requestContext, formatLogMessage("Successfully {} set column - keyspace: {}, table: {}, column: {}, value: {}",
          add ? "added to" : "removed from",
          keySpace,
          table,
          column,
