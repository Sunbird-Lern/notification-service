...
public class TelemetryObjectValidatorV3 implements TelemetryObjectValidator {
  private static Logger logger = LoggerFactory.getLogger(TelemetryObjectValidatorV3.class);
  ...
  public boolean validateAudit(String jsonString) {
    ...
    try {
      ...
      if (!missingFields.isEmpty()) {
        logger.error(
            "Telemetry Object Creation Error for event : {} missing required fields {} ",
