...
public class Constant {
  ...
  public static final String SUNBIRD_NOTIFICAITON_KAFKA_ENABLE = "true";
  ...
  public static final String BROAD_CAST_TOPIC_NOTIFICATION_MESSAGE = "BroadCast Topic Notification";
